...
void gsupper2(int *xnanal,double *xtheta,double *I,double *a,double *b,double *problo,
    ...
    double plo=0.,phi,dphi,btem=0.,btem2,rtdeltak,rtIk,rtIkm1,xlo,xlo2,xhi,theta,mu,tol,bdelta;
    ...
    else b[0]=qnorm(probhi[0],mu,1.,0,0);
    ...
    {   rtIkm1=rtIk; rtIk=sqrt(I[i]); mu=rtIk*theta; rtdeltak=sqrt(I[i]-I[i-1]);
		...
		{   phi=0.; dphi=0.; plo=0.;
            ...
            {   xhi=(z1[ii]*rtIkm1-btem*rtIk+theta*(I[i]-I[i-1]))/rtdeltak;
                ...
                xlo2=(-z1[ii]*rtIkm1-a[i]*rtIk-theta*(I[i]-I[i-1]))/rtdeltak;
