...
void gsbounds2(int *xnanal, double *xtheta, double *I, double *a, double *b,
    ...
    double plo,phi,dplo,dphi,btem=0.,atem=0.,atem2,btem2,rtdeltak,rtIk,rtIkm1,xlo,xlo2,xhi,theta,mu1,mu2;
    ...
    else atem2=qnorm(1-problo[0],mu2,1.,0,0);
    adelta=1.; j=0;
    ...
    m11=gridpts2(r,mu1,a[0],b[0],z11,w11);
    h1(0.,m11,w11,I[0],z11,h11);
    
    m12=gridpts2(r,mu2,a[0],b[0],z12,w12);
    ...
    {   /* set up constants */
	    ...
	    {   plo=0.; dplo=0.; atem=atem2;
            ...
            {   
                ...
                xlo2=(-z12[i2]*rtIkm1-atem*rtIk-theta*(I[i]-I[i-1]))/rtdeltak;
                plo+=h12[i2]*(pnorm(xlo,0.,1.,1,0)-pnorm(xlo2,0.,1.,1,0));
                dplo+=h12[i2]*(rtIk/rtdeltak)*(exp(-xlo*xlo/2)+exp(-xlo2*xlo2/2))/rt2pi;
            }
        ...
        if (i<nanal-1)
        {   m21=gridpts2(r,mu1,a[i],b[i],z21,w21);
            m22=gridpts2(r,mu2,a[i],b[i],z22,w22);
