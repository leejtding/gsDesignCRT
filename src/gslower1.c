...
*/
void gslower1(int *xnanal,double *xtheta,double *I,double *a,double *b,double *problo,
              double *probhi,double *xtol,int *xr,int *retval,int *printerr) {
    int i,ii,j,m1,m2,r,nanal;
    double plo=0.,phi,dplo,atem=0.,atem2,rtdeltak,rtIk,rtIkm1,xlo,xhi,theta,mu,tol,adelta;
    ...
    if (problo[0] <= 0.) b[0]=EXTREMEZ;
    else a[0]=qnorm(problo[0],mu,1.,1,0);
