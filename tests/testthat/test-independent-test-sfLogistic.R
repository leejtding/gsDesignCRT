...
testthat::test_that("Test: alpha - Checking Variable Type,  
  ...
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = "abc", t = c(.1,  .4), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for incorrect variable type"
  )
  
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = 0, t = c(.1,  .4), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
    
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = -1, t = c(.1,  .4), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
...
testthat::test_that("Test: t - Checking Variable Type,  Out-of-Range,  
   ...
   testthat::expect_error(gsDesignCRT::sfLogistic(alpha = .2, t = c("a", "b"), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for incorrect variable type"
  )
  
   
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = .2, t = c(-.5, .75), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
  
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = .2, t = c(-.75, 1), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
  
   
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = .2, t = c(-1, -6), 
                                              param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
...
testthat::test_that("Test: param - Checking Variable Type,  
  ...
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = .025, t = c(.1,  .4), 
                                              param = c("a", "b")),  
                         info = "Checking for incorrect variable type"
  )
  ...
  testthat::expect_error(gsDesignCRT::sfLogistic(alpha = .025, t = c(.2, .5, .7, 1), 
                                              param = c(NULL, 0.2, 0.05, .4)),  
                         info = "Checking for out-of-range of the variable"
  )
...
testthat::test_that("Test: output validation param of length 2,  
  ...
  sp <- gsDesignCRT::sfLogistic(alpha, t, param)$spend
