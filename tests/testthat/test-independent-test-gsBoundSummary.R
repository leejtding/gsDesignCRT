...
testthat::test_that(desc = "Test gsBoundSummary for gsDesignCRT Object", code = {
  x <- gsDesignCRT(nFixSurv = 0, k = 5, test.type = 1, n.fix = 1)
...
testthat::test_that(desc = "Test gsBoundSummary for gsDesignCRT Object with Nname set", code = {
  x <- gsDesignCRT(nFixSurv = 0, k = 5, test.type = 1, n.fix = 1)
...
testthat::test_that(desc = "Test gsBoundSummary for gsDesignCRT Object, test.type > 1", 
                    code = {
  x <- gsDesignCRT(nFixSurv = 3, k = 5, test.type = 4, n.fix = 1)
...
testthat::test_that(desc = "Test gsBoundSummary for gsDesignCRT Object, when nFixSurv is set", 
                    code = {
  x <- gsDesignCRT(nFixSurv = 0.8, k = 5, test.type = 4, n.fix = 1)
...
testthat::test_that(desc = "Test with Probability Of Success(POS) set to TRUE", 
                    code = {
  x <- gsDesignCRT(nFixSurv = 0, delta = .3, delta1 = .3)
