...
## Validate gsDesignCRT benchmrk data from plotASN function.
xx <- gsDesignCRT(k = 2, test.type = 1, alpha = 0.025,beta = 0.1, delta1 = 0.3, 
...
test_that( desc = "check expected sample sizes", code = {
    ...
    ## are based on slightly different formulae in East and gsDesignCRT.
...
test_that("Test plotASN graphs for gsDesignCRT are correctly rendered ", {
