...
testthat::test_that(
  ...
  code = {
    ...
    y <- gsDesignCRT::normalGrid(r = 18, mu = 0, bounds = bounds, sigma = sigma)
...
testthat::test_that(
  ...
  code = {
    ...
    sigma <- 1
    mu <- 0
    y <- gsDesignCRT::normalGrid(r = 6, mu = 0, bounds = bounds, sigma = sigma)
...
testthat::test_that(desc = "Test: checking r out of range", code = {
  ...
  sigma <- 1
  mu <- 0
  expect_error(gsDesignCRT::normalGrid(r = 0.5, mu = 0, bounds = bounds, sigma = sigma))
...
testthat::test_that(desc = "Test: checking sigma out of range", code = {
  ...
  sigma <- -0.000001
  mu <- 0
  expect_error(gsDesignCRT::normalGrid(r = 10, mu = 0, bounds = bounds, sigma = sigma))
})
...
testthat::test_that(desc = "Test: checking gridpts() mu", code = {
  ...
  sigma <- 4
  mu <- -1
  y <- gsDesignCRT::normalGrid(r = 80, mu = mu, bounds = bounds, sigma = sigma)
...
testthat::test_that(desc = "Test: checking bounds length", code = {
  ...
  sigma <- 4
  mu <- -1
  expect_error(gsDesignCRT::normalGrid(r = 6, mu = mu, bounds = bounds, sigma = sigma))
})
