...
testthat::test_that("inappropriate input not flagged with error",{
                    ...
                    expect_error(sequentialPValue(gsD=gsDesignCRT(test.type=2))) # bad test.type
                    expect_error(sequentialPValue(gsD=gsDesignCRT(test.type=3))) # bad test.type
                    expect_error(sequentialPValue(gsD=gsDesignCRT(test.type=5))) # bad test.type
