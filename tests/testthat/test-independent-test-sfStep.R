...
testthat::test_that("test: alpha - Testing incorrect variable type, 
  ...
  testthat::expect_error(gsDesignCRT::sfStep(alpha = "abc",t = c(.25, 0.5,1),
                                            param = c(0.3 ,0.5, 0.65, 0.75)),
                         info = "Checking for incorrect variable type")
  
  testthat::expect_error(gsDesignCRT::sfStep(alpha = 0,t = c(.25, 0.5,1),
...
testthat::test_that("test: t - Testing incorrect variable type, 
  ...
  testthat::expect_error(gsDesignCRT::sfStep(alpha = 0.25,t = c('a', 0.5,1),
                                            param = c(0.3, 0.5, 0.65, 0.75)),
                         info = "Checking for incorrect variable type")
  
  testthat::expect_error(gsDesignCRT::sfStep(alpha = 0.25,t = c(-.25, 0.5,1),
...
testthat::test_that("test: param - Testing incorrect variable type, 
  ...
  testthat::expect_error(gsDesignCRT::sfStep(alpha = 0.25,t = c(0.25, 0.5,1),
...
testthat::test_that("Test: Output validation,
  ...
  spend <- gsDesignCRT::sfStep(alpha = alpha,t = t, param = param)$spend
