...
testthat::test_that("test.ciBinomial.adj", {
  testthat::expect_error(gsDesignCRT::ciBinomial(
...
testthat::test_that("test.ciBinomial.n1", {
  testthat::expect_error(gsDesignCRT::ciBinomial(n1 = "abc", x1 = 2, x2 = 2, n2 = 2),
    info = "Checking for incorrect variable type"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(n1 = 0, x1 = 0, x2 = 2, n2 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(n1 = rep(2, 2), x1 = 2, x2 = 2, n2 = 2),
    info = "Checking for incorrect variable length"
  )
})

testthat::test_that("test.ciBinomial.n2", {
  testthat::expect_error(gsDesignCRT::ciBinomial(n2 = "abc", x1 = 2, x2 = 2, n1 = 2),
    info = "Checking for incorrect variable type"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(n2 = 0, x1 = 2, x2 = 0, n1 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(n2 = rep(2, 2), x1 = 2, x2 = 2, n1 = 2),
    info = "Checking for incorrect variable length"
  )
})
...
testthat::test_that("test.ciBinomial.x1", {
  testthat::expect_error(gsDesignCRT::ciBinomial(x1 = "abc", x2 = 2, n1 = 2, n2 = 2),
    info = "Checking for incorrect variable type"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(x1 = 3, x2 = 2, n1 = 2, n2 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(x1 = c(-1), x2 = 2, n1 = 2, n2 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(x1 = rep(2, 2), x2 = 2, n1 = 2, n2 = 2),
    info = "Checking for incorrect variable length"
  )
})

testthat::test_that("test.ciBinomial.x2", {
  testthat::expect_error(gsDesignCRT::ciBinomial(x2 = "abc", x1 = 2, n1 = 2, n2 = 2),
    info = "Checking for incorrect variable type"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(x2 = 3, x1 = 2, n1 = 2, n2 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(x2 = c(-1), x1 = 2, n1 = 2, n2 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::ciBinomial(x2 = rep(2, 2), x1 = 2, n1 = 2, n2 = 2),
    info = "Checking for incorrect variable length"
  )
})
...
testthat::test_that("test.normalGrid.bounds", {
  testthat::expect_error(gsDesignCRT::normalGrid(bounds = "abc"), info = "Checking for incorrect variable type")
  testthat::expect_error(gsDesignCRT::normalGrid(bounds = 0), info = "Checking for out-of-range variable value")
  testthat::expect_error(gsDesignCRT::normalGrid(bounds = c(2)), info = "Checking for incorrect variable length")
})

testthat::test_that("test.normalGrid.mu", {
  testthat::expect_error(gsDesignCRT::normalGrid(mu = "abc"), info = "Checking for incorrect variable type")
  testthat::expect_error(gsDesignCRT::normalGrid(mu = rep(1, 2)), info = "Checking for incorrect variable length")
})

testthat::test_that("test.normalGrid.r", {
  testthat::expect_error(gsDesignCRT::normalGrid(r = "abc"), info = "Checking for incorrect variable type")
  testthat::expect_error(gsDesignCRT::normalGrid(r = 0), info = "Checking for out-of-range variable value")
  testthat::expect_error(gsDesignCRT::normalGrid(r = 81), info = "Checking for out-of-range variable value")
  testthat::expect_error(gsDesignCRT::normalGrid(r = rep(1, 2)), info = "Checking for incorrect variable length")
})

testthat::test_that("test.normalGrid.sigma", {
  testthat::expect_error(gsDesignCRT::normalGrid(sigma = "abc"), info = "Checking for incorrect variable type")
  testthat::expect_error(gsDesignCRT::normalGrid(sigma = 0), info = "Checking for out-of-range variable value")
  testthat::expect_error(gsDesignCRT::normalGrid(sigma = rep(1, 2)), info = "Checking for incorrect variable length")
})

testthat::test_that("test.Deming.gsProb", {
  w <- sum(gsDesignCRT::gsProbability(k = 2, theta = 0, n.I = 1:2, a = stats::qnorm(0.025) *
    c(1, 1), b = stats::qnorm(0.975) * c(1, 1))$upper$prob)
  x <- sum(gsDesignCRT::gsProbability(k = 4, theta = 0, n.I = 1:4, a = stats::qnorm(0.025) *
    c(1, 1, 1, 1), b = stats::qnorm(0.975) * c(1, 1, 1, 1))$upper$prob)
  y <- sum(gsDesignCRT::gsProbability(k = 10, theta = 0, n.I = 1:10, a = stats::qnorm(0.025) *
    array(1, 10), b = stats::qnorm(0.975) * array(1, 10))$upper$prob)
  z <- sum(gsDesignCRT::gsProbability(k = 20, theta = 0, n.I = 1:20, a = stats::qnorm(0.025) *
...
testthat::test_that("test.JT.OFss", {
  x <- gsDesignCRT::gsDesignCRT(k = 5, test.type = 2, sfu = "OF", beta = 0.2)
  testthat::expect_equal(102.8, round(x$n.I[5] * 100, 1), info = "Checking 2-sided OF (gsDesignCRT n.I), k=4, beta=0.2")
  testthat::expect_equal(102.1, round(x$en[1] * 100, 1), info = "Checking 2-sided Pocock (gsDesignCRT en), k=4, beta=0.2")
  x <- gsDesignCRT::gsDesignCRT(k = 20, test.type = 2, sfu = "OF", beta = 0.1)
  testthat::expect_equal(104.5, round(x$n.I[20] * 100, 1), info = "Checking 2-sided OF (gsDesignCRT n.I), k=20, beta=0.1")
  testthat::expect_equal(103.4, round(x$en[1] * 100, 1), info = "Checking 2-sided Pocock (gsDesignCRT en), k=20, beta=0.1")
})

testthat::test_that("test.JT.Pocock", {
  x <- gsDesignCRT::gsDesignCRT(k = 4, test.type = 2, sfu = "Pocock", beta = 0.2)
  testthat::expect_equal(120.2, round(x$n.I[4] * 100, 1), info = "Checking 2-sided Pocock (gsDesignCRT n.I), k=4, beta=0.2")
  testthat::expect_equal(117.5, round(x$en[1] * 100, 1), info = "Checking 2-sided Pocock (gsDesignCRT en), k=4, beta=0.2")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1, 1.5), d = x)
  testthat::expect_equal(c(117.5, 108.8, 80.5, 52.2), round(
    y$en * 100,
    1
  ), info = "Checking 2-sided Pocock (gsProb), k=4, beta=0.2")
  x <- gsDesignCRT::gsDesignCRT(k = 15, test.type = 2, sfu = "Pocock", beta = 0.1)
  testthat::expect_equal(130.5, round(x$n.I[15] * 100, 1), info = "Checking 2-sided Pocock (gsDesignCRT n.I), k=15, beta=0.1")
  testthat::expect_equal(126.4, round(x$en[1] * 100, 1), info = "Checking 2-sided Pocock (gsDesignCRT en), k=15, beta=0.1")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1, 1.5), d = x)
...
testthat::test_that("test.JT.Power.symm", {
  ...
  testthat::expect_equal(111.7, round(x$n.I[3] * 100, 1), info = "Checking symm 2-sided sfPower (gsDesignCRT n.I), k=3, rho=1")
  testthat::expect_equal(109.9, round(x$en[1] * 100, 1), info = "Checking symm 2-sided sfPower (gsDesignCRT en), k=3, rho=1")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1, 1.5), d = x)
  ...
  testthat::expect_equal(108.1, round(x$n.I[10] * 100, 1), info = "Checking symm 2-sided sfPower (gsDesignCRT), k=10, rho=2")
  testthat::expect_equal(106.6, round(x$en[1] * 100, 1), info = "Checking symm 2-sided sfPower (gsDesignCRT en), k=10, rho=2")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1, 1.5), d = x)
  ...
  testthat::expect_equal(101, round(x$n.I[2] * 100, 1), info = "Checking symm 2-sided sfPower (gsDesignCRT), k=2, rho=3")
  testthat::expect_equal(100.7, round(x$en[1] * 100, 1), info = "Checking symm 2-sided sfPower (gsDesignCRT en), k=2, rho=3")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1, 1.5), d = x)
...
testthat::test_that("test.JT.Power.type3", {
  ...
  testthat::expect_equal(110.1, round(x$n.I[5] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT n.I), k=5, rho=2, beta=0.05")
  testthat::expect_equal(63.4, round(x$en[1] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT en), k=5, rho=2, beta=0.05")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1), d = x)
  ...
  testthat::expect_equal(106.9, round(x$n.I[10] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT n.I), k=10, rho=3, beta=0.05")
  testthat::expect_equal(63.1, round(x$en[1] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT en), k=10, rho=3, beta=0.05")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1), d = x)
  ...
  testthat::expect_equal(107.2, round(x$n.I[3] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT n.I), k=3, rho=2, beta=0.1")
  testthat::expect_equal(68.1, round(x$en[1] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT en), k=3, rho=2, beta=0.1")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1), d = x)
  ...
  testthat::expect_equal(104, round(x$n.I[4] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT n.I), k=4, rho=3, beta=0.1")
  testthat::expect_equal(69.2, round(x$en[1] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT en), k=4, rho=3, beta=0.1")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1), d = x)
  ...
  testthat::expect_equal(104.3, round(x$n.I[2] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT n.I), k=2, rho=2, beta=0.2")
  testthat::expect_equal(74.5, round(x$en[1] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT en), k=2, rho=2, beta=0.2")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1), d = x)
  ...
  testthat::expect_equal(106.9, round(x$n.I[15] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT n.I), k=15, rho=3, beta=0.2")
  testthat::expect_equal(62.2, round(x$en[1] * 100, 1), info = "Checking type3 sfPower (gsDesignCRT en), k=15, rho=3, beta=0.2")
  y <- gsDesignCRT::gsProbability(theta = x$delta * c(0, 0.5, 1), d = x)
...
testthat::test_that("test.sfTDist.param", {
  ...
  testthat::expect_error(gsDesignCRT::sfTDist(param = 1, 1:3 / 4, c(
    0.25, 0.5, 0.75,
    0.1, 0.2, 0.3
  )), info = "Checking for out-of-range variable value")
})
...
testthat::test_that("test.sfTDist.param ", {
  testthat::expect_error(gsDesignCRT::sfTDist(param = "abc"), info = "Checking for incorrect variable type")
})

testthat::test_that("test.simBinomial.adj", {
  testthat::expect_error(gsDesignCRT::simBinomial(
...
testthat::test_that("test.simBinomial.n1", {
  ...
  testthat::expect_error(gsDesignCRT::simBinomial(n1 = 0, p1 = 0.1, p2 = 0.2, n2 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(
...
testthat::test_that("test.simBinomial.n2", {
  ...
  testthat::expect_error(gsDesignCRT::simBinomial(n2 = 0, p1 = 0.1, p2 = 0.2, n1 = 2),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(
...
testthat::test_that("test.simBinomial.p1", {
  testthat::expect_error(gsDesignCRT::simBinomial(p1 = "abc", p2 = 0.1, n1 = 1, n2 = 1),
    info = "Checking for incorrect variable type"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(p1 = 0, p2 = 0.1, n1 = 1, n2 = 1),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(p1 = 1, p2 = 0.1, n1 = 1, n2 = 1),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(
...
testthat::test_that("test.simBinomial.p2", {
  testthat::expect_error(gsDesignCRT::simBinomial(p2 = "abc", p1 = 0.1, n1 = 1, n2 = 1),
    info = "Checking for incorrect variable type"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(p2 = 0, p1 = 0.1, n1 = 1, n2 = 1),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(p2 = 1, p1 = 0.1, n1 = 1, n2 = 1),
    info = "Checking for out-of-range variable value"
  )
  testthat::expect_error(gsDesignCRT::simBinomial(
...
testthat::test_that("test.testBinomial.x1", {
  ...
  testthat::expect_error(gsDesignCRT::testBinomial(x1 = rep(2, 2), x2 = 2, n1 = rep(
    2,
    3
...
testthat::test_that("test.testBinomial.x2", {
  ...
  testthat::expect_error(gsDesignCRT::testBinomial(x2 = rep(2, 2), x1 = 2, n1 = rep(
    2,
    3
  ), n2 = 2), info = "Checking for incorrect variable length")
})
...
testthat::test_that("test.ciBinomial.misc", {
  testthat::expect_equal(as.numeric(gsDesignCRT::ciBinomial(
    x1 = 0, x2 = 0, n1 = 10,
...
testthat::test_that("test.ciBinomial.ORscale.Infinity", {
  testthat::expect_equal(gsDesignCRT::ciBinomial(
...
testthat::test_that("test.nBinomial.misc", {
  testthat::expect_equal(gsDesignCRT::nBinomial(
  ...
  testthat::expect_equal(as.numeric(gsDesignCRT::nBinomial(
  ...
  testthat::expect_equal(gsDesignCRT::nBinomial(p1 = 0.15, p2 = 0.1, beta = 0.2, scale = "or"),
    1355.84,
...
testthat::test_that("test.simBinomial.misc", {
  testthat::expect_equal(sum(-stats::qnorm(0.05) < gsDesignCRT::simBinomial(
    p1 = 0.4, p2 = 0.05,
  ...
  testthat::expect_equal(sum(-stats::qnorm(0.025) < gsDesignCRT::simBinomial(
    p1 = 0.15, p2 = 0.1,
...
testthat::test_that("test.testBinomial.numerics", {
  testthat::expect_equal(gsDesignCRT::testBinomial(
