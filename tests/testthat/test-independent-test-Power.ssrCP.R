...
testthat::test_that(
  desc = "Test : checking x should be class of ssrCP", code = {
    xa <- gsDesignCRT(k = 2, test.type = 2, n.fix = 800, timing = c(0.5, 1),
...
testthat::test_that(
  desc = "Test : output validation
    ...
    xa <- gsDesignCRT(k = 2, test.type = 2, n.fix = 3200, timing = c(0.9, 1),
                   delta1 = 0.1146049, delta0 = 0)
...
testthat::test_that(
  desc = "Test : output validation
          source : East 6.5 output", code = {
    x <- gsDesignCRT(k = 2, test.type = 2, n.fix = 3200, timing = c(0.5, 1),
                  delta1 = 0.1146049, delta0 = 0)
