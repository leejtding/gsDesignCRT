...
testthat::test_that("Test: alpha - Testing incorrect variable type,  
  ...
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = "abc", t = c(.1,  .4), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for incorrect variable type"
  )
  
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = 0, t = c(.1,  .4), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
  
    
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = -1, t = c(.1,  .4), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
...
testthat::test_that("Test: t - Testing incorrect variable type,  out-of-range variable value, order of the list",  {
  ...
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = .025, t = c("a", "b"), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for incorrect variable type"
  )
  
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = .025, t = c(-.5, .75), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
  
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = .025, t = c(-.75, 1), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
  
   
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = .025, t = c(-1, -6), 
                                                  param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
...
testthat::test_that("Test: param - Testing incorrect variable type,  
  ...
  testthat::expect_error(gsDesignCRT::sfExtremeValue(alpha = .025, t = c(.1,  .4), 
                                                  param = c("a", "b")),  
                         info = "Checking for incorrect variable type"
  )
...
testthat::test_that("Test: output validation param length as 2,  
  ...
  sp <- gsDesignCRT::sfExtremeValue(alpha, t, param)$spend
