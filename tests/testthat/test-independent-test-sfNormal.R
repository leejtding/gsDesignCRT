...
testthat::test_that("Test: alpha - Checking Variable Type,  
  ...
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = "abc", t = c(.1,  .4), 
                                            param = c(0.1, 0.2)), 
                         info = "Checking for incorrect variable type"
  )
  
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = -1, t = c(.1,  .4), 
                                            param = c(0.1, 0.2)), 
...
testthat::test_that("Test: t - Checking Variable Type,  
  ...
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = .025, t = c("a", "b"), 
                                            param = c(0.1, 0.2)), 
                         info = "Checking for incorrect variable type"
  )
  ...
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = .025, t = c(-.5, .75), 
                                            param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
  
 
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = .025, t = c(-1, -6), 
                                            param = c(0.1, 0.2)), 
                         info = "Checking for out-of-range variable value"
  )
...
testthat::test_that("Test: param:  - Checking Variable Type,  
  ...
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = .025, t = c(.1,  .4), 
                                            param = c("a", "b")),  
                         info = "Checking for incorrect variable type"
  )
  
 
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = .025, t = c(.1,  .4), param = .4),  
                         info = "Checking for incorrect variable type"
  ) 
  
  testthat::expect_error(gsDesignCRT::sfNormal(alpha = .025, t = c(.1,  .4), param = c(.4)),  
...
testthat::test_that("Test: output validation param of length 2,  
  ...
  sp <- gsDesignCRT::sfNormal(alpha, t, param)$spend
