...
testthat::test_that("Test: alpha - Checking Variable Type, Out-of-Range, 
                    Order-of-List", {
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = "abc", t = c(.1, .4),
                                              param = c(0.1, 0.2)),
                         info = "Checking for incorrect variable type")
  
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = 0, t = c(.1, .4), 
                                              param = c(0.1, 0.2)),
                         info = "Checking for out-of-range variable value")
  
  
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = -1, t = c(.1, .4),
                                              param = c(0.1, 0.2)),
                         info = "Checking for out-of-range variable value")
...
testthat::test_that("Test: t - Checking Variable Type, Out-of-Range, Order-of-List",
  ...
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = .025,t = "a", 
                                              param = c(0.1, 0.2)),
                         info = "Checking for incorrect variable type")
  
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = .025,t = c("a","b"),
                                              param = c(0.1, 0.2)),
                         info = "Checking for incorrect variable type")
  
  
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = .025,t = c(-.5, .75),
                                              param = c(0.1, 0.2)),
                         info = "Checking for out-of-range variable value")
  ...
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = .025, t = c(1, -5),
                                              param = c(0.1, 0.2)),
                         info = "Checking for out-of-range variable value")
...
testthat::test_that("Test: param - Checking Variable Type, Out-of-Range,
  ...
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha = .025, t = c(.1, .4),
                                              param = c("a", "b")), 
                         info = "Checking for incorrect variable type")
  ...
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha=.025,t=c(.1, .4),param=c(1,0)), 
                         info = "Checking for out-of-range of the variable")
  
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha=.025,t=c(.1, .4),param=c(1,-5)), 
                         info = "Checking for out-of-range of the variable")
  
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha=.025,t=c(.1, .4),param=c(-3,-1)),  
                         info = "Checking for out-of-range of the variable")
  ...
  testthat::expect_error(gsDesignCRT::sfBetaDist(alpha=.025,t=c(.1, .1),
...
testthat::test_that("Test: output validation for param of length 2 :
  ...
  sp <- gsDesignCRT::sfBetaDist(alpha, t, param)$spend
