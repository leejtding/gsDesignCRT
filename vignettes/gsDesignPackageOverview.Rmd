---
title: "gsDesignCRT package overview"
output: rmarkdown::html_vignette
bibliography: gsDesignCRT.bib
nocite: |
  @JTBook, @PLWBook
vignette: >
  %\VignetteIndexEntry{gsDesignCRT package overview}
...
gsDesignCRT is a package for deriving and describing group sequential designs.
...
The gsDesignCRT package supports group sequential
...
A `gsDesignCRT` class is defined and returned by the `gsDesignCRT()`
...
Thus, the intent of the gsDesignCRT package is to easily create, fully
