...
The **gsDesignCRT** package was originally designed to have continuous sample size planned rather than integer-based sample size.
...
x <- gsDesignCRT(alpha = .025, beta = .2, n.fix = n.fix, test.type = 1, sfu = sfLDOF, timing = c(.5, .75))
