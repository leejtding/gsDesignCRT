...
investigational spending functions are provided in the gsDesignCRT package.
...
Normally a spending function will be passed to `gsDesignCRT()` in the parameter
...
chapter in the gsDesignCRT technical manual.
