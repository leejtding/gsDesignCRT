...
#' 
#' @param gsD Group sequential design generated by \code{gsDesignCRT} or \code{gsSurv}.
...
#' xupdate <- gsDesignCRT(maxn.IPlan=max(x$n.I),n.I=c(100,160,190,230),usTime=x$timing,
...
#' @export
sequentialPValue <- function(gsD = gsDesignCRT(),
                             n.I = NULL,
                             Z = NULL,
                             usTime = NULL,
                             interval=c(.00001,.9999)){
  # check that gsD has class "gsDesignCRT" (note: this includes "gsSurv" type)
  if (!inherits(gsD, "gsDesignCRT")) stop("d should be an object of class gsDesignCRT or gsSurv")
