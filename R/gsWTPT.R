...
#
# \code{gsDesignCRT} offers the option of using Wang-Tsiatis bounds as an
...
# \eqn{\Delta}{Delta} is supplied to \code{gsDesignCRT()} in the parameter
